...
function ReferenceDetailPage({ params }) {
    ...
    const id = resolvedParams?.id; // Referans ID'si
    const locale = resolvedParams?.locale || "en"; // Varsayılan dil 'en'
    const router = useRouter();

    const [reference, setReference] = useState(null); // Tekil referans
    const [references, setReferences] = useState([]); // Tüm referanslar
                        ...
                        {previousReference && (
                            <div className="previousReference">
                                ...
                                <Link href={`/${locale}/references/${previousReference.id}`} className="ReferenceLink">
                                    <img src={previousReference.image} alt={previousReference.companyName} className="ReferenceImage" />
                                    <div>
                        ...
                        {nextReference && (
                            <div className="nextReference">
                                ...
                                <Link href={`/${locale}/references/${nextReference.id}`} className="ReferenceLink">
                                    <img src={nextReference.image} alt={nextReference.companyName} className="ReferenceImage" />
                                    <div>
